    ...
    <div class="container mx-auto mt-6">
        ...
        <nav class="mb-4 mx-5" aria-label="Breadcrumb">
            <ol class="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
                ...
                <li>
                    <span class="text-gray-600 dark:text-gray-400">Edit Branch</span>
                </li>
            </ol>
        </nav>
        ...
        <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md shadow-lg mx-5">
            <div class="px-6 py-4">
                <h2 class="text-xl font-semibold text-gray-800 dark:text-gray-200">Edit Branch</h2>

                <form action="{{ route('CoreBranch.update', $branch->branch_id) }}" method="POST" class="mt-6 space-y-4">
                    @csrf
                    @method('PUT')
                    ...
                    <div>
                        ...
                        <input type="text" name="branch_code" id="branch_code" value="{{ old('branch_code', $branch->branch_code) }}" required
                    ...
                    <div>
                        ...
                        <input type="text" name="branch_name" id="branch_name" value="{{ old('branch_name', $branch->branch_name) }}" required
                               class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="branch_city" id="branch_city" value="{{ old('branch_city', $branch->branch_city) }}" required
                               class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="branch_address" id="branch_address" rows="3" required
                                  class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">{{ old('branch_address', $branch->branch_address) }}</textarea>
                    </div>

                    <!-- Branch Manager -->
                    <div>
                        <label for="branch_manager" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Manager</label>
                        <input type="text" name="branch_manager" id="branch_manager" value="{{ old('branch_manager', $branch->branch_manager) }}" required
                               class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="email" name="branch_email" id="branch_email" value="{{ old('branch_email', $branch->branch_email) }}" required
                               class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="branch_phone1" id="branch_phone1" value="{{ old('branch_phone1', $branch->branch_phone1) }}" required
                               class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                    </div>
                    ...
                    <div class="flex justify-end">
                        ...
                        <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg transition duration-200 ease-in-out">Save Changes</button>
                    </div>
                </form>
            </div>
        </div>
