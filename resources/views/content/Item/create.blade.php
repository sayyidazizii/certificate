    ...
    <div class="container mx-auto mt-6">
        ...
        <nav class="mb-4 mx-5" aria-label="Breadcrumb">
            <ol class="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
                ...
                <li>
                    <span class="text-gray-600 dark:text-gray-400">Tambah Item</span>
                </li>
            </ol>
        </nav>
                    ...
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        <form action="{{ route('item.store') }}" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="item_name" id="item_name" class="mt-1 block w-full rounded-md shadow-sm bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200" value="{{ old('item_name') }}">
                                @error('item_name')
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" name="stock" id="stock" class="mt-1 block w-full rounded-md shadow-sm bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200" value="{{ old('stock') }}">
                                @error('stock')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="unit_cost" id="unit_cost" class="mt-1 block w-full rounded-md shadow-sm bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200" value="{{ old('unit_cost') }}">
                                @error('unit_cost')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="unit_price" id="unit_price" class="mt-1 block w-full rounded-md shadow-sm bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200" value="{{ old('unit_price') }}">
                                @error('unit_price')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="flex justify-start">
                                ...
                                <a href="{{ route('item.index') }}" class="bg-gray-500 text-white px-4 py-2 rounded">
                                    {{ __('Cancel') }}
                                </a>
                            </div>
                        </form>
