    ...
    <div class="container mx-auto mt-6">
        ...
        <nav class="mb-4 mx-5" aria-label="Breadcrumb">
            <ol class="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
                ...
                <li>
                    <span class="text-gray-500">Create Winner</span>
                </li>
            </ol>
        </nav>
        ...
        <div
            ...
            <div class="flex justify-between items-center mb-6 mx-8 my-2">
                <h1 class="text-2xl font-semibold text-gray-800 dark:text-gray-200 mx-2">Create Winner</h1>
            ...
            <!-- Create Form -->
            <form action="{{ route('winner.store') }}" method="POST" class="space-y-4 mx-8 my-6">
                @csrf

                <!-- Winner Name -->
                <div class="mb-4">
                    <label for="winner_name" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                        {{ __('Winner Name') }}
                    </label>
                    <input type="text" id="winner_name" name="winner_name" value="{{ old('winner_name') }}"
