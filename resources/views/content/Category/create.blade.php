                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('category.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="category_name" id="category_name" class="mt-1 block w-full rounded-md shadow-sm bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200" value="{{ old('category_name') }}">
                            @error('category_name')
