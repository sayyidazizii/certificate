                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('unit.update', $unit) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" id="name" class="mt-1 block w-full rounded-md shadow-sm bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200" value="{{ old('name', $unit->name) }}">
                            @error('name')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="code" id="code" class="mt-1 block w-full rounded-md shadow-sm bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200" value="{{ old('code', $unit->code) }}">
                            @error('code')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
